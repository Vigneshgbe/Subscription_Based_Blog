...
$stmt = $db->prepare("
    SELECT u.*, 
        ...
        (SELECT COUNT(*)  FROM reading_history WHERE user_id = u.id) as reads
    FROM users u
    $where
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .mini-stat{flex:1;background:#f8f9fa;border-radius:8px;padding:15px;text-align:center}
        ...
        .user-cell-info small{color:#999;font-size:12px}
        ...
        .confirm-box .btns{display:flex;gap:15px;justify-content:center}
    </style>
</head>
<body>
