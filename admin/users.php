...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .sidebar{width:260px;background:#1a1d29;color:white;padding:30px 0;position:fixed;height:100vh;overflow-y:auto;z-index:1000;transition:transform 0.3s ease}
        ...
        .main-content{flex:1;margin-left:260px;padding:30px;transition:margin-left 0.3s ease}
